export function getClassMetrics(students, states) {
    ...
    for (const state of active)
        distribution[state.lessonUnderstanding < 25 ? 'struggling' : state.lessonUnderstanding < 50 ? 'partial' : state.lessonUnderstanding < 80 ? 'acquired' : 'mastered']++;
