...
export interface Session { id: string; slotId: string; lessonId: string; type: string; sessionType?: import('../domain.js').SessionType; difficulty?: number; status: 'planned' | 'completed' }
