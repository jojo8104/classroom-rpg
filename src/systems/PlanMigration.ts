...
export interface PreparationSave { plans:ClassroomPlans;students:Student[];classRelations?:ClassRelations; teacher?: import('../domain.js').Teacher }
export function migratePreparationSave(saved: PreparationSave,scenario: PrototypeScenario): PreparationSave {
  ...
  if(saved.teacher) oldScenario.teacher = saved.teacher;
