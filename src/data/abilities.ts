import type { ReactionAbility } from '../domain.js';
import type { UsageKind } from './progressionRules.js';

interface AbilityBase {
  id: string; name: string; archetype: string; requiredLevel: number;
  usage: UsageKind; perRound: number; perLesson: number;
}
export type AbilityDefinition = AbilityBase & ({ mode: 'REACTION'; reaction: ReactionAbility } | { mode: 'MAIN'; action: 'SUPPORT' });
